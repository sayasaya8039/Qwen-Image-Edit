		...
		<div className="min-h-screen bg-[var(--ps-bg-dark)] text-[var(--ps-text)]">
			...
			<main className="max-w-4xl mx-auto px-6 py-8">
				...
				<section className="mb-10">
					...
					<div className="panel p-6 rounded-lg border border-[var(--ps-border)] mb-4">
						...
						<div className="grid md:grid-cols-2 gap-4">
							...
							>
								...
								<svg
									aria-hidden="true"
									className="w-5 h-5 ml-auto text-[var(--ps-text-muted)] group-hover:text-[var(--ps-accent)]"
									fill="none"
									stroke="currentColor"
									viewBox="0 0 24 24"
								>
					...
					<div className="panel p-6 rounded-lg border border-[var(--ps-border)]">
						...
						>
							...
							<svg
								aria-hidden="true"
								className="w-5 h-5 text-[var(--ps-text-muted)] group-hover:text-[var(--ps-accent)]"
								fill="none"
								stroke="currentColor"
								viewBox="0 0 24 24"
							>
						...
						<table className="w-full text-sm">
							...
							<tbody>
								<tr className="border-t border-[var(--ps-border)]">
									...
									<td className="p-3 text-[var(--ps-text-muted)]">
										画像生成・編集・合成
									</td>
								</tr>
								<tr className="border-t border-[var(--ps-border)]">
					...
					<div className="grid md:grid-cols-2 gap-6">
						...
						<div className="panel p-6 rounded-lg border border-[var(--ps-border)]">
							...
							<ol className="text-sm space-y-2 text-[var(--ps-text-muted)]">
								<li>
									1.{" "}
									<code className="bg-[var(--ps-bg-light)] px-1 rounded">
										start_local.bat
									</code>{" "}
									をダウンロード
								</li>
				...
				<section className="mb-10">
					...
					<div className="grid md:grid-cols-3 gap-4">
						<div className="panel p-4 rounded-lg border border-[var(--ps-border)]">
							<div className="text-sm text-[var(--ps-text-muted)] mb-1">
								エントリー
							</div>
						...
						<div className="panel p-4 rounded-lg border border-[var(--ps-accent)] border-opacity-50">
							<div className="text-sm text-[var(--ps-accent)] mb-1">
								ミドル（推奨）
							</div>
				...
				<section className="mb-10">
					...
					<div className="space-y-4">
						...
						<details className="panel p-4 rounded-lg border border-[var(--ps-border)] cursor-pointer group">
							...
							<p className="mt-3 text-sm text-[var(--ps-text-muted)]">
								DirectML対応モデル（Stable Diffusion
								1.5）のみ動作します。他のモデルはNVIDIA GPU（CUDA）が必要です。
							</p>
						</details>
					</div>
				</section>
				...
				<footer className="text-center text-sm text-[var(--ps-text-muted)] pt-8 border-t border-[var(--ps-border)]">
					<p>
						問題が発生した場合は、
						<a
							href="https://github.com/your-repo/Qwen-Image-Edit-2511/issues"
							className="text-[var(--ps-accent)] hover:underline"
						>
							GitHub Issues
						</a>{" "}
						でお知らせください。
