---
description: CLAUDE.md・.claude配下を読み込み、コンテキスト圧縮
allowed-tools: Read, Glob, Grep, Bash(python:*), Bash(sed:*), Bash(bun:*), Bash(npm:*), Bash(cargo:*), Bash(uv:*), mcp__memory__*, mcp__github__*, mcp__context7__*
---
